let captionFortunaKUN156 = [
    {
        picture: './images/fortuner/KUN156.jpg',
        caption: "Fortuna KUN156",
        "AFTER 2020": "5W-30",
        "2015 - 2020": "5W-30",
        "BEFORE 2015": "15W-40",
    }
...
let shopItemsFortunaKUN156 = [
    {
        id:"engineOil1L15W40FortunaKUN156",
    ...
    {
        id:"engineOil4L15W40FortunaKUN156",
        img:"../images/product pic/engineoil.jpg",
    ...
    {
        id:"engineOil5L15W40FortunaKUN156",
        img:"../images/product pic/engineoil.jpg",
    ...
    {
        id:"engineOil1L5W30FortunaKUN156",
        img:"../images/product pic/engineoil.jpg",
    ...
    {
        id:"engineOil4L5W30FortunaKUN156",
        img:"../images/product pic/engineoil.jpg",
    ...
    {
        id:"engineOil5L5W30FortunaKUN156",
        img:"../images/product pic/engineoil.jpg",
    ...
    {
        id:"sumpPlugWasherFortunaKUN156",
    ...
    {
        id:"fuelFilterMainFortunaKUN156",
    ...
    {
        id:"airConditionFilterFortunaKUN156",
    ...
    {
        id:"engineCoolant1LFortunaKUN156",
    ...
    {
        id:"engineCoolant5LFortunaKUN156",
        img:"../images/product pic/coolant.jpg",
...
shopItemsFortunaKUN156.map((obj)=>{
...
// console.log(shopItemsFortunaKUN156);